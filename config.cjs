...
const config = {
  ...
  BOT_NAME: process.env.BOT_NAME || "<| 𝙲𝙾𝚂𝙼𝙸𝙲🪖𝚆𝙰𝚁𝚁𝙸𝙾𝚁",
  BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| bright",
  CAPTION: process.env.CAPTION || "> *© Powered By cosmic warrior*",
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "1234567890@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "<| 𝙲𝙾𝚂𝙼𝙸𝙲🪖𝚆𝙰𝚁𝚁𝙸𝙾𝚁",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "263788533181",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "263788533181",
